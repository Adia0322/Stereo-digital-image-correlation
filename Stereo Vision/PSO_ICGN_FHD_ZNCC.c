/*  PSO_ICGN_FHD 2022.05.09 22:28 Success rate test*/ 
...
/* DIC 參數設定 */ 
#define Size 17  /* 方形子集合邊長 */ 
#define SizeHalf (Size-1)/2 
#define scan 121        /* 方形掃描區域邊長 */ 
/* PSO 參數設定 */ 
...
/* functions */
double Cost_function(int Pi_u, int Pi_v, int Object_point[], int img_aft[][img_cloumn],\
